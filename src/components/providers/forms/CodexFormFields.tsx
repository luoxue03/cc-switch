...
function SortableCatalogRow({
  ...
  return (
    <div
      ...
      style={style}
      className={cn(
        "grid grid-cols-1 gap-2 md:grid-cols-[40px_1fr_1fr_140px_150px_36px]",
    ...
    >
      ...
      />
      <Select
        value={normalizeRouteMode(row.routeMode, "responses")}
        onValueChange={(value) =>
          onUpdate(index, {
            routeMode:
                ...
                {catalogRows.length > 0 && (
                  ...
                  >
                    ...
                    >
                      <div className="space-y-2">
                        {/* 列头：md+ 显示 */}
                        <div className="hidden grid-cols-[40px_1fr_1fr_140px_150px_36px] gap-2 px-1 text-xs font-medium text-muted-foreground md:grid">
                          <span>
